...
contract Arbitrage is DyDxFlashLoan {
    ...
    constructor(address _sRouter, address _uRouter) {
        sRouter = IUniswapV2Router02(_sRouter); // Sushiswap called from the deploy.js script
        uRouter = IUniswapV2Router02(_uRouter); // Uniswap called from the deploy.js script
        owner = msg.sender;
    }
